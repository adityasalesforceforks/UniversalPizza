Webruntime.define('lwc/simpleIteratorDemo', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    **/
    ...
    function tmpl$3($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 1
      }, api_iterator($cmp.franchise, function (item, index) {
        return api_element("p", {
          classMap: {
            "slds-m-around_small": true
          },
          key: api_key(0, item.Id)
        }, [api_dynamic(index), api_text(" - "), api_dynamic(item.Name), api_text(" \xA0 "), api_dynamic(item.Type)]);
      })), api_element("div", {
        classMap: {
        ...
        key: 5
      }, api_iterator($cmp.franchise, function (itValue, itIndex, itFirst, itLast) {
        return api_element("li", {
          ...
          key: api_key(4, itValue.Id)
        }, [itFirst ? api_element("div", {
          classMap: {
            "slds-border_top": true
          },
          key: 2
        }, []) : null, api_dynamic(itValue.Name), api_text(" \xA0 "), api_dynamic(itValue.Type), itLast ? api_element("div", {
          classMap: {
            "slds-color__background_gray-1": true
          },
          key: 3
        }, [api_text("hello world")]) : null]);
      }))])];
    }
