Webruntime.define('lwc/simpleCalculatorDemo', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';

    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".main" + shadowSelector + " {min-height: 100px;min-width: 100px;}\n";
    }
    ...
    **/
    ...
    var card = lwc.registerTemplate(tmpl$g);
    tmpl$g.stylesheets = [];
    ...
    var inline = lwc.registerTemplate(tmpl$h);
    tmpl$h.stylesheets = [];
    ...
    if (_implicitStylesheets$5) {
      tmpl$i.stylesheets.push.apply(tmpl$i.stylesheets, _implicitStylesheets$5);
    }
    ...
    */
    ...
    if (_implicitStylesheets$2) {
      tmpl$l.stylesheets.push.apply(tmpl$l.stylesheets, _implicitStylesheets$2);
    }
    ...
    * */
    ...
    function tmpl$n($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        classMap: {
          "slds-col": true,
          "slds-size_2-of-3": true,
          "slds-box_border": true,
          "slds-color__background_gray-4": true,
          "slds-m-around_x-small": true
        },
        key: 3
      }, [api_element("p", {
        key: 2
      }, [api_text("Answer = "), api_dynamic($cmp.result)])]), api_custom_element("lightning-button", _lightningButton, {
        classMap: {
          "slds-p-around_small": true,
          "slds-m-around_x-small": true,
          "slds-col": true
        ...
        key: 4,
        on: {
          "click": _m2 || ($ctx._m2 = api_bind($cmp.handleAdd))
        }
        ...
        key: 5,
        on: {
          "click": _m3 || ($ctx._m3 = api_bind($cmp.handleSubtraction))
        }
      }, []), api_custom_element("lightning-button", _lightningButton, {
        classMap: {
          "slds-p-around_small": true,
        ...
        key: 6,
        on: {
          "click": _m4 || ($ctx._m4 = api_bind($cmp.handleMultiplication))
        }
      }, []), api_custom_element("lightning-button", _lightningButton, {
        classMap: {
          "slds-p-around_small": true,
        ...
        key: 7,
        on: {
          "click": _m5 || ($ctx._m5 = api_bind($cmp.handleDivision))
        }
      }, [])])])];
    }
    ...
    tmpl$n.stylesheetTokens = {
      hostAttribute: "lwc-simpleCalculatorDemo_simpleCalculatorDemo-host",
      shadowAttribute: "lwc-simpleCalculatorDemo_simpleCalculatorDemo"
    };

    class SimpleCalculatorDemo extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.numberOne = void 0;
        this.numberTwo = void 0;
        this.result = void 0;
      }

      handleChange(event) {
        console.log(event.target.name);
        event.target.name === "input1" ? this.numberOne = event.target.value : this.numberTwo = event.target.value;
      }
    ...
    lwc.registerDecorators(SimpleCalculatorDemo, {
      fields: ["numberOne", "numberTwo", "result"]
    });

    var simpleCalculatorDemo = lwc.registerComponent(SimpleCalculatorDemo, {
      tmpl: _tmpl$m
    });

    return simpleCalculatorDemo;
