Webruntime.define('lwc/simpleCalculatorDemo', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    **/
    ...
    if (_implicitStylesheets$2) {
      tmpl$5.stylesheets.push.apply(tmpl$5.stylesheets, _implicitStylesheets$2);
    }
    ...
    **/
    ...
    if (_implicitStylesheets$3) {
      tmpl$d.stylesheets.push.apply(tmpl$d.stylesheets, _implicitStylesheets$3);
    }
    ...
    if (_implicitStylesheets$4) {
      tmpl$i.stylesheets.push.apply(tmpl$i.stylesheets, _implicitStylesheets$4);
    }
    ...
    */
    ...
    if (_implicitStylesheets$1) {
      tmpl$l.stylesheets.push.apply(tmpl$l.stylesheets, _implicitStylesheets$1);
    }
